...
original = imageio.imread(os.path.join(dir_path, o_img))
marked = imageio.imread(os.path.join(dir_path, m_img))
...
imageio.imsave(os.path.join(dir_path, 'colorized.bmp'), colorizedRGB, format='bmp')
